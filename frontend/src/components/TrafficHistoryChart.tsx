...
const POLL_INTERVAL_MS = 2000   // 실시간처럼 보이도록 주기적으로 다시 불러온다
...
// refreshSignal: 부모(트래픽 증가/감소 버튼)가 값을 바꾸면 폴링 주기를 기다리지 않고 즉시 재조회한다.
export default function TrafficHistoryChart({ refreshSignal }: { refreshSignal?: number } = {}) {
